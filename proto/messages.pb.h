...
PROTOBUF_NAMESPACE_OPEN
template <>
::Location* Arena::CreateMaybeMessage<::Location>(Arena*);
template <>
::OneToAll* Arena::CreateMaybeMessage<::OneToAll>(Arena*);
template <>
::OneToOne* Arena::CreateMaybeMessage<::OneToOne>(Arena*);
template <>
::Request* Arena::CreateMaybeMessage<::Request>(Arena*);
template <>
::Response* Arena::CreateMaybeMessage<::Response>(Arena*);
template <>
::Walk* Arena::CreateMaybeMessage<::Walk>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
constexpr Response_Status Response_Status_Status_MAX = static_cast<Response_Status>(1);
constexpr int Response_Status_Status_ARRAYSIZE = 1 + 1;
...
inline const std::string& Response_Status_Name(Response_Status value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfDenseEnum<Response_Status_descriptor,
                                                 0, 1>(
...
class Walk final :
 ...
 public:
  ...
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& lengths() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* mutable_lengths();

  private:
  ::uint32_t _internal_lengths(int index) const;
  void _internal_add_lengths(::uint32_t value);
  const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& _internal_lengths() const;
  ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* _internal_mutable_lengths();
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _lengths_cached_byte_size_;
    mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  };
  union { Impl_ _impl_; };
  friend struct ::TableStruct_messages_2eproto;
...
class Response final :
 ...
 public:
  ...
  static constexpr Status OK = Response_Status_OK;
  static constexpr Status ERROR = Response_Status_ERROR;
...
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& Walk::lengths() const {
  // @@protoc_insertion_point(field_list:Walk.lengths)
  return _internal_lengths();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* Walk::mutable_lengths() {
...
inline void Walk::_internal_add_lengths(::uint32_t value) { _impl_.lengths_.Add(value); }
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>& Walk::_internal_lengths() const {
  return _impl_.lengths_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField<::uint32_t>* Walk::_internal_mutable_lengths() {
  return &_impl_.lengths_;
}
...
inline PROTOBUF_ALWAYS_INLINE void Response::set_errmsg(Arg_&& arg,
                                                     Args_... args) {
  ;
...
inline void Response::set_allocated_errmsg(std::string* value) {
...
template <>
struct is_proto_enum<::Response_Status> : std::true_type {};
template <>
